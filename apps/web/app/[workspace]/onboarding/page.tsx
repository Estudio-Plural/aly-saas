...
import { useState, use, type ComponentType } from "react";
...
type StepType = "question" | "message" | "end";
...
export default function OnboardingPage({
  ...
  const saveFlow = () => {
    localStorage.setItem(`workspace-${workspace}-onboarding`, JSON.stringify(steps));
    ...
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-neutral-600 mt-1">Diseñá la conversación inicial con tus usuarios</p>
        </div>
        <Button onClick={saveFlow} className="bg-blue-600 hover:bg-blue-700 text-white">
